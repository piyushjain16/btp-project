...
logging.basicConfig(filename="gamma_DCE_sigmoid.log", filemode="a", format="%(levelname)s: %(message)s",level=logging.INFO)
...
def lowlight(image_path, label_path,gamma_net):
	...
	enhanced_image, _ = gamma_net(data_lowlight)
...
def train(config):
	...
	for epoch in range(config.num_epochs):
		for iteration, img_lowlight in enumerate(train_loader):
			...
			enhanced_image,A  = gamma_net(img_lowlight)
...
if __name__ == "__main__":
	...
	parser.add_argument('--snapshots_folder', type=str, default="E:/python/Zero-DCE-master/Zero-DCE_code/snapshot_gamma_with_sigmoid_newloss/")
